...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="shipping-calculator-btn btn-primary"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a></h2>
	...
	<section class="shipping-calculator-form">
		...
		<p><btn btn-primary type="submit" name="calc_shipping" value="1" class="btn btn-primary"><?php _e( 'Update Totals', 'woocommerce' ); ?></btn btn-primary></p>
