...
<div class = "col-md-3 col-sm-6">
    ...
    <h4>Pretty Themes</h4>
    <p>Fall in love with Great and useful design.</p> 
                ...
                <div class="portfolio-desc text-center">
                    <h4 class="portfolio-post-title"><a href="<?php the_permalink(); ?>" rel="bookmark"><?php the_title(); ?></a></h4>
                     <p><?php the_excerpt(); ?>
                      ...
                      <a href="<?php the_permalink(); ?>" rel="bookmark" class="btn btn-primary">More Details <i class="fa fa-chevron-circle-right"></i> </a>  <a href="<?php get_post_meta( get_the_ID(), 'demo_link', true ); ?>" rel="bookmark" class="btn btn-danger">Theme Preview <i class="fa fa-eye"></i></a> </p>
                </div>
            </div>
        </div><!--portfolio item -->
